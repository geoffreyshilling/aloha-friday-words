...
if ( ! function_exists( 'ord808af_rewrite_flush' ) ) {
	/**
	 * Flush the rewrite rules once Mug Monday CPT is created.
	 *
	 * @return void
	*/
	function ord808af_rewrite_flush() {
		// call the CPT registration function
	    ord808_register_aloha_friday_post_type();
		/* Flush rewrite rules for custom post types. */
	    flush_rewrite_rules();
	}
}
register_activation_hook( __FILE__, 'ord808af_rewrite_flush' );
